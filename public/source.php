...
<html lang="en">
    ...
    <body class="bg-dark text-light">
        ...
        <div class="container">
            ...
            <span>chart.php</span>
            <script src="https://emgithub.com/embed.js?target=https%3A%2F%2Fgithub.com%2Fder-neue%2Fsensors%2Fblob%2Fswitching-tables%2Fpublic%2Fchart.php&style=atom-one-dark&showBorder=on&showLineNumbers=on"></script>
        </div>
    </body>
</html>